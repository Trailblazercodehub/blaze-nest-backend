"""
URL configuration for blazenest project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="Blazenest API",
      default_version='v1',
      description="API documentation for Blazenest",
    #   terms_of_service="https://www.learnxcess.com/terms/",
    #   contact=openapi.Contact(email="contact@learnxcess.com"),
